...
tatool.factory('tatoolContinuousOrientationFeedback', ['executableUtils', 'dbUtils', 'timerUtils', 'stimulusServiceFactory', 'inputServiceFactory',
  function (executableUtils, dbUtils, timerUtils, stimulusServiceFactory, inputServiceFactory) {
    ...
    var FEEDBACK_DURATION_DEFAULT = 2500;
    var SET_SIZES = [2, 4, 6];
    var N_TRIALS = 20;
    ...
    ContinuousOrientation.prototype.init = function () {
      ...
      this.feedbackTimer = timerUtils.createTimer(this.feedbackDuration, true, this);
    ...
    ContinuousOrientation.prototype.processResponse = function (givenResponse, canvas) {
      ...
      var delta = this.trial.givenResponse - this.trial.probeAngle;
      ...
      this.trial.deviationAbs = Math.abs(this.trial.deviation);
        console.log('deviation',this.trial.deviation)
    ...
    /*ContinuousOrientation.prototype.stopExecution = function () {
        canvas.dispose();
